...
/** Map from book search form value to criteria info.
...
const FORM_VALUE_TO_SEARCH_CRITERIA_INFO: readonly SearchCriteriaInfo[] = [
  {
    ...
    usageDescription: SearchCriteriaUsageDescription.SearchBookByText,
  },
  {
    name: SearchCriteriaName.DateRange,
    usageDescription: SearchCriteriaUsageDescription.SearchBookByDateRange,
  },
  {
    name: SearchCriteriaName.Genre,
    usageDescription: SearchCriteriaUsageDescription.SearchBookByGenre,
  },
];

/** Map values from search book form field into search criteria. */
@Injectable({
  providedIn: 'root',
})
export class BookSearchCriteriaMapperService
